...
export function renderOrderSummary() {
  ...
  let cartSummaryHTML = '';
  //перебираем массив корзины для поиска совпадающих продуктов
  ...
  document.querySelectorAll('.js-delivery-option').forEach((element) =>{
    element.addEventListener('click', () =>{
      ...
      renderOrderSummary(); 
      renderPaymentSummary (); //обновляет страницу при каждом клике,так как весь фунционал обернут в 1 функцию, нет надобности менять текст отдельно
    });
  });
}
